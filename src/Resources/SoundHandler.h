...
private:
    ...
    //How long should an inactive sound stay loaded for?
    unsigned int inactiveSoundTimeout;
...
protected:
    //Protected constructor so that only ResourceManager can access its functions
    SoundHandler();
};
